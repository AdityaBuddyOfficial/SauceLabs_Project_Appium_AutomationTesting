...
public class TC2_InvalidLoginTest {
    WebDriver driver;
    HomePage homepage;
    ...
    @Test
//    TC#2 Login with invalid username or password and display error message
    ...
    {
        new LoginPage(driver).invalidLogin("standard_user","secret_sauc")
                .errorDisplayCheck();
